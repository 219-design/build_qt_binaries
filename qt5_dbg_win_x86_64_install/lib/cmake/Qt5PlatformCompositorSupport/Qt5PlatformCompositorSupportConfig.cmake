...
set(Qt5PlatformCompositorSupport_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    set(Qt5PlatformCompositorSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.15.0"
        "${_qt5PlatformCompositorSupport_install_prefix}/include/QtPlatformCompositorSupport/5.15.0/QtPlatformCompositorSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PlatformCompositorSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5PlatformCompositorSupport_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::PlatformCompositorSupport)
    ...
    if (EXISTS "${_qt5PlatformCompositorSupport_install_prefix}/lib/Qt5PlatformCompositorSupport.lib" )
