...
set(Qt5DBus_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/QtDBus/5.15.0"
        "${_qt5DBus_install_prefix}/include/QtDBus/5.15.0/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::DBus)
    ...
    _populate_DBus_target_properties(DEBUG "Qt5DBusd.dll" "Qt5DBusd.lib" FALSE)

    if (EXISTS
        "${_qt5DBus_install_prefix}/bin/Qt5DBus.dll"
      AND EXISTS
        "${_qt5DBus_install_prefix}/lib/Qt5DBus.lib" )
        _populate_DBus_target_properties(RELEASE "Qt5DBus.dll" "Qt5DBus.lib" FALSE)
    endif()
