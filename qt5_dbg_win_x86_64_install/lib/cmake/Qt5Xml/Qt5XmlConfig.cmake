...
set(Qt5Xml_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/QtXml/5.15.0"
        "${_qt5Xml_install_prefix}/include/QtXml/5.15.0/QtXml"
    )
    ...
    foreach(_module_dep ${_Qt5Xml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5Xml_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::Xml)
    ...
    if (EXISTS
        "${_qt5Xml_install_prefix}/bin/Qt5Xml.dll"
      AND EXISTS
        "${_qt5Xml_install_prefix}/lib/Qt5Xml.lib" )
