...
set(Qt5QmlModels_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/include/QtQmlModels/5.15.0"
        "${_qt5QmlModels_install_prefix}/include/QtQmlModels/5.15.0/QtQmlModels"
    )
    ...
    foreach(_module_dep ${_Qt5QmlModels_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5QmlModels_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QmlModels)
    ...
    if (EXISTS
        "${_qt5QmlModels_install_prefix}/bin/Qt5QmlModels.dll"
      AND EXISTS
        "${_qt5QmlModels_install_prefix}/lib/Qt5QmlModels.lib" )
