...
set(Qt5QmlWorkerScript_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/QtQmlWorkerScript/5.15.0"
        "${_qt5QmlWorkerScript_install_prefix}/include/QtQmlWorkerScript/5.15.0/QtQmlWorkerScript"
    )
    ...
    foreach(_module_dep ${_Qt5QmlWorkerScript_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5QmlWorkerScript_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QmlWorkerScript)
    ...
    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/bin/Qt5QmlWorkerScript.dll"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/lib/Qt5QmlWorkerScript.lib" )
