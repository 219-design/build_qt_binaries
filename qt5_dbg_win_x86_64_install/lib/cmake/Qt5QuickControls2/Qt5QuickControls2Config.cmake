...
set(Qt5QuickControls2_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/QtQuickControls2/5.15.0"
        "${_qt5QuickControls2_install_prefix}/include/QtQuickControls2/5.15.0/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QuickControls2)
    ...
    _populate_QuickControls2_target_properties(DEBUG "Qt5QuickControls2d.dll" "Qt5QuickControls2d.lib" FALSE)

    if (EXISTS
        "${_qt5QuickControls2_install_prefix}/bin/Qt5QuickControls2.dll"
      AND EXISTS
        "${_qt5QuickControls2_install_prefix}/lib/Qt5QuickControls2.lib" )
        _populate_QuickControls2_target_properties(RELEASE "Qt5QuickControls2.dll" "Qt5QuickControls2.lib" FALSE)
    endif()
