...
if (NOT TARGET Qt5::Multimedia)
    ...
    set_property(TARGET Qt5::Multimedia
                 ...
                 alsa;gpu_vivante;gstreamer_1_0;gstreamer_0_10;gstreamer;gstreamer_app;gstreamer_encodingprofiles;gstreamer_gl;gstreamer_imxcommon;gstreamer_photography;linux_v4l;openal;pulseaudio;resourcepolicy)
    ...
    _populate_Multimedia_target_properties(DEBUG "Qt5Multimediad.dll" "Qt5Multimediad.lib" FALSE)

    if (EXISTS
        "${_qt5Multimedia_install_prefix}/bin/Qt5Multimedia.dll"
      AND EXISTS
        "${_qt5Multimedia_install_prefix}/lib/Qt5Multimedia.lib" )
        _populate_Multimedia_target_properties(RELEASE "Qt5Multimedia.dll" "Qt5Multimedia.lib" FALSE)
    endif()
