...
set(Qt5QuickParticles_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    set(Qt5QuickParticles_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickParticles_install_prefix}/include/QtQuickParticles/5.15.0"
        "${_qt5QuickParticles_install_prefix}/include/QtQuickParticles/5.15.0/QtQuickParticles"
    )
    ...
    foreach(_module_dep ${_Qt5QuickParticles_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5QuickParticles_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QuickParticles)
    ...
    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/bin/Qt5QuickParticles.dll"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/lib/Qt5QuickParticles.lib" )
