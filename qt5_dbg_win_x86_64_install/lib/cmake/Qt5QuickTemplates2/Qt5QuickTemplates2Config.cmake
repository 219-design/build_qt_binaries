...
set(Qt5QuickTemplates2_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.15.0"
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.15.0/QtQuickTemplates2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QuickTemplates2)
    ...
    if (EXISTS
        "${_qt5QuickTemplates2_install_prefix}/bin/Qt5QuickTemplates2.dll"
      AND EXISTS
        "${_qt5QuickTemplates2_install_prefix}/lib/Qt5QuickTemplates2.lib" )
