...
set(Qt5EventDispatcherSupport_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    set(Qt5EventDispatcherSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EventDispatcherSupport_install_prefix}/include/QtEventDispatcherSupport/5.15.0"
        "${_qt5EventDispatcherSupport_install_prefix}/include/QtEventDispatcherSupport/5.15.0/QtEventDispatcherSupport"
    )
    ...
    foreach(_module_dep ${_Qt5EventDispatcherSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5EventDispatcherSupport_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::EventDispatcherSupport)
    ...
    if (EXISTS "${_qt5EventDispatcherSupport_install_prefix}/lib/Qt5EventDispatcherSupport.lib" )
