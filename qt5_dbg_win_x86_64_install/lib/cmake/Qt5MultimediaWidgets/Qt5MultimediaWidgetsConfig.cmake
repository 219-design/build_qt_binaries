...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    _populate_MultimediaWidgets_target_properties(DEBUG "Qt5MultimediaWidgetsd.dll" "Qt5MultimediaWidgetsd.lib" FALSE)

    if (EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/bin/Qt5MultimediaWidgets.dll"
      AND EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/lib/Qt5MultimediaWidgets.lib" )
        _populate_MultimediaWidgets_target_properties(RELEASE "Qt5MultimediaWidgets.dll" "Qt5MultimediaWidgets.lib" FALSE)
    endif()
