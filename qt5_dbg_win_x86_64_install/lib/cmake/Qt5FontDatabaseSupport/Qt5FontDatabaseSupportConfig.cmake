...
set(Qt5FontDatabaseSupport_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::FontDatabaseSupport)
    ...
    set(Qt5FontDatabaseSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FontDatabaseSupport_install_prefix}/include/QtFontDatabaseSupport/5.15.0"
        "${_qt5FontDatabaseSupport_install_prefix}/include/QtFontDatabaseSupport/5.15.0/QtFontDatabaseSupport"
    )
    ...
    foreach(_module_dep ${_Qt5FontDatabaseSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5FontDatabaseSupport_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::FontDatabaseSupport)
    ...
    if (EXISTS "${_qt5FontDatabaseSupport_install_prefix}/lib/Qt5FontDatabaseSupport.lib" )
