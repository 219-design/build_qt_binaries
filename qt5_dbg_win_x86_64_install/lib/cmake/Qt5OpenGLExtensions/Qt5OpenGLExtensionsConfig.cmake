...
set(Qt5OpenGLExtensions_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    foreach(_module_dep ${_Qt5OpenGLExtensions_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5OpenGLExtensions_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::OpenGLExtensions)
    ...
    if (EXISTS "${_qt5OpenGLExtensions_install_prefix}/lib/Qt5OpenGLExtensions.lib" )
