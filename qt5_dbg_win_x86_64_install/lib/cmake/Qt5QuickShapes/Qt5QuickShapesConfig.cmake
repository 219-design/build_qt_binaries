...
set(Qt5QuickShapes_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/QtQuickShapes/5.15.0"
        "${_qt5QuickShapes_install_prefix}/include/QtQuickShapes/5.15.0/QtQuickShapes"
    )
    ...
    foreach(_module_dep ${_Qt5QuickShapes_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5QuickShapes_FIND_VERSION_EXACT}
    ...
    if(NOT "${QT_NO_CREATE_VERSIONLESS_TARGETS}" AND NOT TARGET Qt::QuickShapes)
    ...
    if (EXISTS
        "${_qt5QuickShapes_install_prefix}/bin/Qt5QuickShapes.dll"
      AND EXISTS
        "${_qt5QuickShapes_install_prefix}/lib/Qt5QuickShapes.lib" )
